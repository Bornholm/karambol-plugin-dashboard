...
class WidgetBlueprintsSubscriber implements EventSubscriberInterface {
  ...
  protected function getBlueprints() {
    ...
    $feedBlueprint
      ->setName('feed')
      ->setDescription($translator->trans('plugins.dashboard.admin.blueprints.feed_description'))
